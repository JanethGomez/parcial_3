package com.example.parcial3janeth.adapter;
...
import com.example.parcial3janeth.R;
import com.example.parcial3janeth.VerActivity;
...
public class ListaAdapter extends RecyclerView.Adapter<ListaAdapter.ContactoViewHolder>{

    ArrayList<Contactos> listaContactos;
    ArrayList<Contactos> listaOriginal;

    public ListaAdapter(ArrayList<Contactos> listaContactos) {
    ...
    public void onBindViewHolder(@NonNull ContactoViewHolder holder, int position) {
        ...
        holder.viewApellido.setText(listaContactos.get(position).getApellidos());
