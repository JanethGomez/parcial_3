...
public class EditarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ContactosDao dbContactos = new ContactosDao(EditarActivity.this);
        ...
        btnGuarda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!txtNombre.getText().toString().equals("") && !txtApellido.getText().toString().equals("") && !txtTelefono.getText().toString().equals("")) {
                    ...
                    c.setCorreo_electornico(txtCorreo.getText().toString());
                    correcto = dbContactos.editarContacto(c);
